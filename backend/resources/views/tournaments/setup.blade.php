								...
								<div class="col-lg-4 col-md-6">
									...
									<select name="type" id="stage_type_select">
										...
										{{-- thai (TournamentThaiService) нигде не вызывается бэкендом — скрыто из
										     ...
										     double_elim временно скрыт (Вариант A) — resolveByes() не пробрасывает
										     BYE в нижнюю сетку при небинарном числе команд (report/double-elim-bye-stuck.md),
										     8/15 матчей зависают в TBD. generateDoubleElimination() и разметка
										     #double_elim_fields ниже НЕ удалены — вернём вместе с фиксом BYE. --}}
										@if($isBeach)
