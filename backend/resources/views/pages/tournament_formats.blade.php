...
<div class="ramka">
    <div class="card p-3 mb-3" style="background:rgba(231,97,47,.06);border:1px solid rgba(231,97,47,.2)">
        ...
        <div class="f-14" style="color:#6b7280">
            ...
            Неформально и весело — <strong>Король площадки</strong> или <strong>Тайский формат</strong><br>
            Индивидуально на пляже — <strong>Король пляжа</strong>
        </div>
    </div>
</div>
...
{{-- Король пляжа --}}
<div class="ramka">
    <h2 class="-mt-05">🏖️ Король пляжа (King of the Beach)</h2>
    <div class="card p-3 mb-2">
        <div class="f-14 mb-2"><strong>Суть:</strong> Индивидуальный формат для пляжного волейбола. Игроки регистрируются поодиночке, временно объединяются в пары внутри группы и борются за попадание в следующий раунд по сумме набранных очков.</div>
        <div class="f-14 mb-2"><strong>Как работает:</strong> Участники делятся на группы по 4 человека. В каждой группе играется 3 партии с ротацией пар: A+B vs C+D → A+C vs B+D → A+D vs B+C. Очки каждого игрока суммируются по всем 3 партиям: победившая пара получает счёт победителей, проигравшая — счёт проигравших. Двое с наибольшей суммой очков выходят в следующий раунд, где из прошедших формируются новые группы по 4. Так продолжается до финальной четвёрки.</div>
        <div class="f-14 mb-2"><strong>Пример (группа A+B vs C+D):</strong></div>
        <div class="table-scrollable mb-2">
            <table class="table" style="font-size:13px;width:auto">
                <thead>
                    <tr>
                        <th>Партия</th><th>Пара 1</th><th>Счёт</th><th>Пара 2</th><th>A</th><th>B</th><th>C</th><th>D</th>
                    </tr>
                </thead>
                <tbody>
                    <tr><td>1</td><td>A+B</td><td>21:17</td><td>C+D</td><td>21</td><td>21</td><td>17</td><td>17</td></tr>
                    <tr><td>2</td><td>A+C</td><td>15:21</td><td>B+D</td><td>15</td><td>21</td><td>21</td><td>21</td></tr>
                    <tr><td>3</td><td>A+D</td><td>21:19</td><td>B+C</td><td>21</td><td>19</td><td>19</td><td>21</td></tr>
                    <tr style="font-weight:700;border-top:2px solid rgba(128,128,128,.3)"><td colspan="4">Итого</td><td>57</td><td>61</td><td>57</td><td>59</td></tr>
                </tbody>
            </table>
        </div>
        <div class="f-14">Проходят в следующий раунд: <strong>B (61 очко)</strong> и <strong>D (59 очков)</strong>.</div>
        <div class="row mt-2">
            <div class="col-md-6">
                <div class="f-14 mb-1" style="color:#10b981"><strong>Плюсы:</strong></div>
                <div class="f-13" style="color:#6b7280">Все играют с каждым в разных парах, честно определяет лучшего индивидуального игрока, много равнозначных встреч, никто не выбывает после первой же ошибки</div>
            </div>
            <div class="col-md-6">
                <div class="f-14 mb-1" style="color:#dc2626"><strong>Минусы:</strong></div>
                <div class="f-13" style="color:#6b7280">Число участников должно быть кратно 4, требует точного учёта индивидуальных очков</div>
            </div>
        </div>
        <div class="f-13 mt-2" style="color:#9ca3af"><strong>Где используют:</strong> AVP Tour (США), FIVB Beach Pro Tour, любительские пляжные фестивали, тренировочные турниры</div>
    </div>
</div>
