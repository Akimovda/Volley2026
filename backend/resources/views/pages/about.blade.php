...
<div class="ramka text-center" style="background:linear-gradient(135deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%);color:#fff;padding:3rem 2rem">
    ...
    <p style="font-size:1.15rem;opacity:.9;max-width:660px;margin:0 auto 1.5rem">
        Полноценная экосистема для волейбольного сообщества — от любительских игр до профессиональных лиг. Запись на мероприятия, турниры, рейтинги, школы волейбола, бронирование кортов и CRM для организаторов.
    </p>
        ...
        <div class="col-md-6">
            <div class="card" style="height:100%">
                ...
                <ul class="list f-15">
                    ...
                    <li>Твой прогресс не потеряется — честный рейтинг после каждого матча, который считается сам (OpenSkill)</li>
                    <li>Место в игре не упустишь — лист ожидания подхватит его сам, даже если ты не следишь</li>
                </ul>
                <div class="mt-2">
                    <a href="{{ route('events.index') }}" class="btn">Найти мероприятие</a>
                </div>
        ...
        <div class="col-md-6">
            <div class="card" style="height:100%">
                ...
                <ul class="list f-15">
                    ...
                    <li>Оплата прямо при регистрации — автоматически через ЮKassa или по ссылке Т-Банк / Сбер</li>
                    <li>Турниры и лиги без экселя — сетки, рейтинги и промоушен между дивизионами считаются автоматически</li>
                </ul>
                <div class="mt-2">
                    <a href="{{ route('about') }}#org" class="btn">Стать организатором</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row row2 mt-2">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card text-center" style="height:100%">
                ...
                <p class="f-14">Принимайте прямые брони кортов от игроков с онлайн-оплатой, размещайте расписание площадок и следите за загрузкой и выручкой через единую платформу.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="ramka" id="players">
    ...
    <div class="row row2">
        ...
        <div class="col-md-6">
            <ul class="list f-15">
                <li>📈 Честный рейтинг уровня игры — считается сам после каждого матча (OpenSkill)</li>
                ...
                <li>⭐ Премиум-подписка — приоритет в листе ожидания, персональные уведомления о новых играх</li>
...
<div class="ramka" id="rating">
    ...
    <div class="row row2">
        <div class="col-md-4">
            <div class="card" style="height:100%">
                <h3 style="margin:.25rem 0 .5rem">⚡ OpenSkill — честный рейтинг</h3>
                <p class="f-14">Считается сам после каждого матча и учитывает не только победы, но и силу соперников. Для технарей: байесовский алгоритм μ/σ, публичная оценка — консервативный CR&nbsp;=&nbsp;μ&nbsp;−&nbsp;3σ, которой можно доверять.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card" style="height:100%">
...
{{-- ТРЕКЕР ТРЕНИРОВОК --}}
<div class="ramka" id="activity">
    <h2 class="-mt-05">❤️ Трекер тренировок</h2>
    <p class="f-15" style="opacity:.8;margin-bottom:1.5rem">
        Подключите BLE-датчик пульса в мобильном приложении и следите за нагрузкой прямо во время игры.
    </p>
    <div class="row row2">
        <div class="col-md-6">
            <ul class="list f-15">
                <li>❤️ Пульс в реальном времени с BLE-датчика (нательный пояс, часы)</li>
                <li>🔥 Расход калорий и время в пульсовых зонах за тренировку</li>
                <li>📈 Средний/максимальный пульс и общая нагрузка (load score)</li>
            </ul>
        </div>
        <div class="col-md-6">
            <ul class="list f-15">
                <li>🦘 Счётчик и высота прыжков — для совместимых устройств</li>
                <li>📊 Тренд высоты прыжка по сравнению с прошлыми тренировками</li>
                <li>📱 Доступно в мобильном приложении iOS и Android</li>
            </ul>
        </div>
    </div>
    <div class="mt-2">
        <a href="{{ route('activity.index') }}" class="btn btn-secondary">Мои тренировки</a>
    </div>
</div>
...
{{-- КЛУБНЫЙ МОДУЛЬ / БРОНИРОВАНИЕ КОРТОВ --}}
<div class="ramka" id="club">
    <h2 class="-mt-05">🏟️ Бронирование кортов для клубов</h2>
    <p class="f-15" style="opacity:.8;margin-bottom:1.5rem">
        Инструменты для владельцев площадок и спортивных центров: занятость залов и приём броней в одном окне.
    </p>
    <div class="row row2">
        <div class="col-md-6">
            <ul class="list f-15">
                <li>🗓️ Таймлайн загрузки кортов по направлениям и залам</li>
                <li>🏐 Игроки бронируют корт напрямую на сайте, без звонков администратору</li>
                <li>💳 Онлайн-оплата брони через ЮKassa</li>
                <li>✅ Подтверждение или отклонение брони владельцем площадки</li>
            </ul>
        </div>
        <div class="col-md-6">
            <ul class="list f-15">
                <li>📊 Аналитика загрузки и выручки по кортам и направлениям</li>
                <li>🔔 Уведомления о новых бронях, оплате и напоминаниях</li>
                <li>↩️ Гибкая политика отмены и возврата средств</li>
                <li>🏆 Автоматическая привязка турнирных матчей к конкретным кортам</li>
            </ul>
        </div>
    </div>
    <div class="mt-2">
        <a href="{{ route('locations.index') }}" class="btn btn-secondary">Найти площадку</a>
    </div>
</div>
