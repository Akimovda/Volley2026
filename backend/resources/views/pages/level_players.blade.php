        ...
        <div class="ramka">
			<div class="level-section">
											...
											<table class="table table-levels">
												...
												<thead>
													<tr>
														...
														<th width="15%" class="text-center">Баллы</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														<td><strong class="levelmark level-1">Начальный</strong></td>
													...
													<tr>
														<td><strong class="levelmark level-2">Начальный +</strong></td>
													...
													<tr>
														<td><strong class="levelmark level-3">Средний −</strong></td>
													...
													<tr>
														<td><strong class="levelmark level-4">Средний</strong></td>
													...
													<tr>
														<td><strong class="levelmark level-5">Средний +</strong></td>
													...
													<tr class="level-pro">
														<td><strong class="levelmark level-6">Полупрофи (К.М.С)</strong></td>
													...
													<tr class="level-pro">
														<td><strong class="levelmark level-7">Профи (М.С.)</strong></td>
													...
													<tr class="level-banned">
														<td><strong>Уровень «БОГ»</strong></td>
														<td>«Бог» — самоуверенный средний любитель, неадекватно оценивающий свой уровень.</td>
														<td class="text-center"><span class="badge bg-danger">БАН</span></td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="table-scrollable">
											...
											<table class="table table-levels">
												...
												<tbody>
													...
													<tr class="level-pro">
														<td><strong>Полупрофи (К.М.С)</strong></td>
				...
				<div class="formula-box">
					<h5>Как считается (если записались только мужчины)</h5>
				...
				<div class="formula-box">
					<h5>Если есть девушки (и девушек меньше, чем мужчин)</h5>
