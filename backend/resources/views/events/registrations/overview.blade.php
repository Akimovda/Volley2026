    ...
    <div class="container">
		...
		<div class="users-filter">
			<div class="ramka">
				...
				{{-- Фильтры --}}
				<form method="GET" action="{{ route('events.registrations.manage') }}">
											<label>{{ __('events.overview_sort_label') }}:</label>
					<div class="row">
						{{-- Сортировка --}}
						<div class="col-md-4">
						...
						class="btn btn-secondary">
							{{ $dir === 'asc' ? __('events.overview_dir_asc') : __('events.overview_dir_desc') }}
						</a>
						</div>
						<div class="col-md-4">
						{{-- Прошедшие --}}
						<label class="checkbox-item">
							...
							<span>{{ __('events.overview_show_past') }}</span>
