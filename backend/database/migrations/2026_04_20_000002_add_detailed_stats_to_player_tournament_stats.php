...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('player_tournament_stats', function (Blueprint $table) {
            $table->unsignedInteger('total_serves')->default(0)->after('point_diff');
            ...
            $table->unsignedInteger('total_points_detailed')->default(0)->after('total_assists')->comment('aces+kills+blocks');
