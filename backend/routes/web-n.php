...
Route::get('/auth/vk/redirect', [\App\Http\Controllers\Auth\VkAuthController::class, 'redirect'])
    ->name('auth.vk.redirect');

Route::get('/auth/vk/widget', [\App\Http\Controllers\Auth\VkAuthController::class, 'widget'])
    ->name('auth.vk.widget');

Route::get('/auth/vk/callback', [\App\Http\Controllers\Auth\VkAuthController::class, 'callback'])
...
/* ============================================================================
 | Static pages
 | ============================================================================ */
Route::view('/level_players', 'pages.level_players')->name('pages.level_players');
Route::view('/personal_data_agreement', 'pages.personal_data_agreement')->name('pages.personal_data_agreement');
