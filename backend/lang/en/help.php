...
return [
    ...
    'p5_p4' => 'If an organizer has enabled <strong>cash payment tracking</strong>, after the event they mark on their side who actually paid on site. The event page does not show a cash payment status before that — you will only find out from a notification. If you are marked as unpaid, you will get a reminder to pay within 12 hours; if the organizer does not confirm your payment within that time, registering for any of that organizer\'s future events will be blocked until they mark your payment as received.',
    ...
    'o4_p5' => '<strong>Cash payment tracking</strong> — if you choose "Cash" as the payment method for a paid event, a "Payment tracking" checkbox appears at creation. Without it, cash payment is just "pay on site" with no control at all. Enable the checkbox if you want to check after the event who actually paid: go to "Transactions" → "Cash control" → the event, tick the players who paid, and save. Once the event has started, you will get a reminder to go and mark the payments.',
    'o4_p6' => 'Marking someone as paid immediately lifts any restriction they may have. Marking someone as unpaid after the event has started starts a 12-hour timer — if you do not confirm the payment within that time, the player\'s access to registering for ANY of your events is automatically restricted (indefinitely, until you mark the payment as received). If you never open the tracking page, the system marks everyone as paid automatically 24 hours after the event ends, with no restrictions at all; if you mark only some players, the rest get a reminder and the same 12-hour timer applies.',
