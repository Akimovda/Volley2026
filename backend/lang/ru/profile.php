...
return [
    ...
    'apple_link_success'      => 'Apple ID привязан ✅',
    'apple_link_already_yours'=> 'Apple ID уже привязан к вашему аккаунту.',
    'apple_link_taken'        => 'Этот Apple ID уже привязан к другому аккаунту.',
    'apple_link_have_other'   => 'К вашему аккаунту уже привязан другой Apple ID.',
    ...
    // Настройки уведомлений (список в существующей секции profile.sec_notifications — дом для будущих переключателей)
    'notif_new_events_city_label'      => 'Уведомлять о новых мероприятиях в моём городе',
    'notif_new_events_city_hint'       => 'Личное сообщение, когда в вашем городе появляется новое мероприятие с открытой записью.',
    'notif_new_events_city_no_city'    => 'Укажите город в профиле, чтобы получать такие уведомления.',
    'notif_setting_saved'              => 'Сохранено',
    ...
    'premium_offer_li_6'  => '⚡ Автозапись на мероприятие — заранее выбираете игру, система сама запишет вас, когда откроется регистрация',
    ...
    'cp_missing_for_event'   => 'Для записи на мероприятие заполните:',
    'cp_return_to_event'     => 'Вернуться на мероприятие',
    ...
    'idx_btn_show'          => 'Показать',
    'idx_btn_reset'         => 'Сбросить',
    'idx_section_search'    => 'Поиск игрока',
    'idx_section_classic_lvl' => 'Ур. классика',
    'idx_section_beach_lvl' => 'Ур. пляжка',
    'idx_gender_all_seg'    => 'Все',
    'idx_gender_m_seg'      => 'Мужчины',
    'idx_gender_f_seg'      => 'Женщины',
    ...
    'positions' => [
        ...
        'opposite'     => 'Диагональный',
        'middle'       => 'Центральный блокирующий',
        'middle_full'  => 'Центральный блокирующий',
        'libero'       => 'Либеро',
    ],
    ...
    'photos_tournament_h2'       => 'Турнирный альбом',
    'photos_radio_tournament'    => 'Турнирный альбом',
    'photos_tournament_empty'    => 'Нет турнирных фото. Загрузите с выбором «Турнирный альбом».',
    ...
    'dash_org_h2_dynamics' => '📈 Динамика записей',
    'dash_org_h2_load'     => '🏐 Загрузка мероприятий',
    ...
    // === volleyball_school ===
    'school_idx_title'     => 'Секции и школы волейбола — для детей и взрослых | VOLLEY CLUB',
    'school_idx_h1'        => 'Секции и школы волейбола',
    'school_idx_description' => 'Секции по волейболу для детей, взрослых и подростков: школы, клубы, спортивные секции. Тренировки, обучение, команды в вашем городе.',
    'school_idx_t_description' => 'Секции, школы и клубы волейбола рядом с вами!',
