...
return [
    ...
    // Иконка приложения (только в нативном приложении)
    'sec_app_icon'          => 'Иконка приложения',
    'app_icon_lead'         => 'Выберите иконку приложения на экране устройства.',
    'app_icon_default'      => 'Стандартная',
    'app_icon_option'       => 'Вариант :n',
    'app_icon_set_error'    => 'Не удалось сменить иконку. Попробуйте ещё раз.',
    ...
    'pay_ctrl_hint'           => 'Если у игрока нет отметки — ему отправится напоминание о необходимости оплатить. Важно! Если он не будет отмечен оплатившим в течение 12 часов после сохранения (это правило действует только после ваших правок, когда мероприятие идет или завершено) — доступ к записи на Ваши мероприятия будет автоматически ограничен.',
    ...
    'pay_ccidx_col_payment'    => 'Оплата',
    'pay_ccidx_col_action'     => 'Действие',
    'pay_ccidx_empty'          => 'Нет мероприятий с включённым учётом оплаты наличными.',
    'pay_ccidx_unpaid_badge'   => ':n не оплатили',
    'pay_ccidx_paid_ok'        => 'Все оплатили',
    'pay_ccidx_title_unpaid_hint' => 'Есть игроки без подтверждённой оплаты',

    'pay_ccidx_filter_search_label' => 'Поиск',
    'pay_ccidx_filter_search_ph'    => 'Название или локация',
    'pay_ccidx_filter_range_label'  => 'Показать',
    'pay_ccidx_filter_range_current' => 'Текущие',
    'pay_ccidx_filter_range_archive' => 'Архив',
    'pay_ccidx_filter_range_all'     => 'Все',
    'pay_ccidx_filter_unpaid_only'   => 'Только с неполной оплатой',
    'pay_ccidx_filter_submit'        => 'Найти',
    'pay_ccidx_filter_reset'         => 'Сбросить',
